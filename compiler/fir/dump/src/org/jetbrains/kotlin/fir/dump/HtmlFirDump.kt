...
internal interface FirLinkResolver {
    ...
    fun symbolSignature(symbol: AbstractFirBasedSymbol<*>): String
    fun nearSymbolLocation(symbol: AbstractFirBasedSymbol<*>): String?
...
class MultiModuleHtmlFirDump(private val outputRoot: File) {
    ...
    private inner class LinkResolver(origin: File) : FirLinkResolver {
        ...
        override fun symbolSignature(symbol: AbstractFirBasedSymbol<*>): String {
        ...
        override fun nearSymbolLocation(symbol: AbstractFirBasedSymbol<*>): String? {
...
class HtmlFirDump internal constructor(private var linkResolver: FirLinkResolver, private val session: FirSession) {
    ...
    private fun AbstractFirBasedSymbol<*>.describe(): String {
        return when (this) {
    ...
    private fun FlowContent.symbolRef(symbol: AbstractFirBasedSymbol<*>?, body: FlowContent.() -> Unit) {
