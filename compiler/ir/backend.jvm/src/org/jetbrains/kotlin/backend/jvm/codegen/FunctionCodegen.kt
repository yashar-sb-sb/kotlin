...
open class FunctionCodegen(
    ...
    private fun doGenerate(): JvmMethodGenericSignature {
        ...
        val signature = classCodegen.methodSignatureMapper.mapSignatureWithGeneric(
            functionView,
        ...
        if (!state.classBuilderMode.generateBodies || flags.and(Opcodes.ACC_ABSTRACT) != 0 || irFunction.isExternal) {
            ...
            ExpressionCodegen(functionView, frameMap, InstructionAdapter(methodVisitor), classCodegen, isInlineLambda).generate()
